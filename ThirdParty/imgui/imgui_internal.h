...
{
    ImVector<ImDrawList*>*  ObjectLayers[2];      // Pointers to global layers for: regular, tooltip. LayersP[0] is owned by DrawData.
...
//#endif
    ...
    IMGUI_API void          DebugNodeInputTextState(ImGuiInputTextState* stateIndex);
    IMGUI_API void          DebugNodeTypingSelectState(ImGuiTypingSelectState* stateIndex);
